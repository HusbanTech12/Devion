...
const plans = [
  {
    ...
    price: "$499",
    badge: "Launch Fast",
    desc: "Perfect for startups and businesses establishing a professional online presence.",
    features: [
      "Premium Business Website (5–7 Pages)",
  ...
  },
  {
    ...
    badge: "Most Popular",
    popular: true,
    desc: "A scalable fullstack solution with AI integration and advanced business tools.",
    features: [
      "Custom Fullstack Web Application",
  ...
  },
  {
    ...
    desc: "A complete AI-powered ecosystem for businesses ready to scale aggressively.",
    features: [
